<template lang="html">
  <main>
    <h1>Icons</h1>
    <p>We use <i>DripIcons webfont</i> for to display symbols where possible.</p>
    <p>In CSS, use the font-family <code>dripicons-v2</code>. Check out <a href="http://demo.amitjakhu.com/dripicons/" target="_blank">Dripicons V2</a> for character mapping.</p>
    <br>
    <p>Usage: In HTML, use the class <code>.dripicons-</code> with the icon name as suffix.</p>
    <p>E.g. For the <span class="dripicons-alarm"/> icon : <code>class="dripicons-alarm"</code></p>
